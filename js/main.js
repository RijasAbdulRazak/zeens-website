...
/* For preview only */
var theme2 = '<link rel="stylesheet" type="text/css" href="css/red-theme.css">';
var theme3 = '<link rel="stylesheet" type="text/css" href="css/black-theme.css">';
...
var themeBtnStyle = '<style>.bctheme-holder{display:none;position:fixed;width:1.5rem;top:50%;right:1rem;z-index:999999} .bctheme{display:inline-block;width:1.5rem;height:1.5rem;border:0.2rem solid #fff;border-radius:2rem;cursor:pointer;box-shadow: 0 0.2rem 0.5rem rgba(0,0,0,0.2);} .bctheme.t1{background-color:#840BFC} .bctheme.t2{background-color:#FC300B} .bctheme.t3{background-color:#000}</style>';
...
function removeOtherStyles(){
    $('link[href="css/red-theme.css"]', 'head').remove();
    $('link[href="css/black-theme.css"]', 'head').remove();
}
/* For preview end */
"use strict"
